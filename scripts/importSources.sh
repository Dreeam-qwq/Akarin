...
paperworkdir="$basedir/Sustopia/Paper/work"
paperserverdir="$basedir/Sustopia/Sustopia-Server"
...
minecraftversion=$(cat "$basedir"/Sustopia/Paper/work/BuildData/info.json | grep minecraftVersion | cut -d '"' -f 4)
